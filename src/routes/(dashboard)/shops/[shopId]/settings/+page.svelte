<script lang="ts">
  ...
  import Media from "$features/dashboard/settings/Banners.svelte"
...
<h1 class="font-bold text-3xl text-header mb-8">Наповнення магазинy</h1>

<DashboardSection>
  <h3 class="text-header text-xl font-bold mb-6">Профіль</h3>

  <label class="text-secondary-400 mb-2 block" for="name">Назва магазину</label>
  <input
...
<DashboardSection class="mt-8">
  <h3 class="text-header text-xl font-bold">Соціальні мережі</h3>
  <p class="text-secondary-400 mt-2 mb-8">
  ...
  <div class="grid grid-cols-[auto_1fr_auto] gap-x-5 gap-y-4 mt-8 items-center">
    <p class="text-secondary-400">Назва</p>
    <p class="text-secondary-400">Посилання</p>
    <p />
