...
<div class="flex flex-row h-full">
    <div class="basis-1/2 h-full grid">
       ...
       <div class="row-span-3 md:row-span-4">
         ...
         <select  bind:value={selected} on:change={setStatus} class="w-5/6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
