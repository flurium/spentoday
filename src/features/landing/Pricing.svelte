<section
  ...
  id="price"
>
  <h2 class="md:col-start-2 md:col-span-2 text-2xl md:text-6xl font-bold mb-5 md:mb-10">
  ...
  <div class="p-8 bg-white rounded-xl grid grid-rows-[auto_1fr_auto]">
    <header>
      ...
      <p class="text-secondary-500 font-bold text-3xl md:text-4xl mt-2">$0/місяць</p>
    </header>
  ...
  <div class="p-8 bg-brand-dark rounded-xl grid grid-rows-[auto_1fr_auto]">
    <header>
      ...
      <p class="text-secondary-400 font-bold text-3xl md:text-4xl mt-2">$20/місяць</p>
    </header>
  ...
  <div class="p-8 bg-brand-pink rounded-xl grid grid-rows-[auto_1fr_auto]">
    <header>
      ...
      <p class="text-secondary-100 font-bold text-3xl md:text-4xl mt-2">$100/місяць</p>
    </header>
