<section
  class="px-5 md:px-6 py-9 md:py-[100px] max-w-screen-xl m-auto
  grid grid-cols-1 md:grid-cols-3 gap-3"
  id="benefits"
>
  <div class="grid grid-cols-3 hover:-translate-y-2 transition-transform">
    <div
      class="col-start-3 bg-white h-7 rounded-t-lg
  ...
  <div class="grid grid-cols-3 hover:-translate-y-2 transition-transform">
    <div
      class="col-start-3 bg-brand-green h-7 rounded-t-lg
      border-b-2 border-dashed border-secondary-100"
    />
  ...
  <div class="grid grid-cols-3 hover:-translate-y-2 transition-transform">
    <div
      class="col-start-3 bg-brand-violet h-7 rounded-t-lg
      border-b-2 border-dashed border-secondary-100"
    />
